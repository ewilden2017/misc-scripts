...
def main():
    ...
    for word in words:
        for p in args.phonemes:
            ...
            # Skip this phoneme if not found.
            if loc == -1:
                continue
            ...
            # TODO need to identify what makes up a phoneme. Dipthongs(?), dicritics(x), long, affricates, etc., doubled.
            ...
            if loc == 0:
                ...
                while unicodedata.combining(prev[0]):
                    cnt += 1
